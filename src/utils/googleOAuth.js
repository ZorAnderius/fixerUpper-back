...
const GOOGLE_OAUTH_CLIENT_ID = env(ENV_VARS.GOOGLE_OAUTH.CLIENT_ID);
const GOOGLE_OAUTH_CLIENT_SECRET = env(ENV_VARS.GOOGLE_OAUTH.CLIENT_SECRET);
const GOOGLE_OAUTH_REDIRECT_URI = env(ENV_VARS.NODE_ENV)  === 'development' ? env(ENV_VARS.GOOGLE_OAUTH.REDIRECT_URI_LOCAL) : env(ENV_VARS.GOOGLE_OAUTH.REDIRECT_URI);
